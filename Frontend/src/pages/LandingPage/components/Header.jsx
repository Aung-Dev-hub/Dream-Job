          ...
          <div className="flex items-center space-x-3">
            {isAuthenticated ? (
              ...
              <>
                ...
                <a href="/signup" className="bg-linear-to-r from-blue-600 to-purple-600 text-white px-6 py-3 rounded-lg font-medium hover:from-blue-700 hover:to-purple-700 transition duration-300 shadow-sm hover:shadow-md">
                  Sign Up
                </a>
              </>
            )}
