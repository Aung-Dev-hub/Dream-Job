...
const Hero = () => {
  ...
  const user = { fullName: "Aung", role: "employer" };
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          >
            <motion.button
              ...
              whileTap={{ scale: 0.98 }}
              className="group bg-linear-to-r from-blue-600 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold text-lg hover:from-blue-700 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow flex items-center space-x-2"
            ...
            whileHover={{ scale: 1.02 }}
            whileTap={{ scale: 0.98}}
            className="bg-white border-2 border-gray-200 text-gray-700 px-8 p-4 rounded-xl font-semibold text-lg hover:border-gray-300 hover:bg-gray-50 transition-all duration-300 shadow-sm hover:shadow-md"
