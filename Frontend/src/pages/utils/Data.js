...
export const jibSeekerFeatures = [
    {
        icon: Search,
        title: "Smart Job Matching",
        description:
        "AI-powered algorithm matches you with relevant opportunities based on your skills and performance.",
    },
    {
        icon: FileText,
...
export const employerFeatures = [
    ...
    },
    {
        ...
        title: "Quick Hiring",
        description:
        "Streamlined hiring process reduces time-to-hire by with automated screaming tools.",
    },
];
...
export const NAVIGATION_MENU = [
    ...
    { id: "post-job", name: "PPost Job", icon: Plus },
